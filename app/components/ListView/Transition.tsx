                              ...
                              <span className="flex flex-col justify-center items-center">
                                {minipage === "about" ? (
                                  ...
                                  <>
                                    ...
                                    <div className="h-[260px] w-[510px] shadow-custom grid grid-cols-2 grid-rows-6 gap-x-7 mt-5">
                                      <h1 className="flex justify-end">HP</h1>
                                      <span className="ml-5">
                                        <progress
                                          className="progress progress-secondary w-[180px]"
